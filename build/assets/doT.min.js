...
n;"undefined"!==typeof module&&module.exports?module.exports=h:"function"===typeof define&&define.amd?define(function(){return h}):(n=function(){return this||(0,eval)("this")}(),n.doT=h);String.prototype.encodeHTML=p();var r={start:"'+(",end:")+'",endencode:"||'').toString().encodeHTML()+'"},s={start:"';out+=(",end:");out+='",endencode:"||'').toString().encodeHTML();out+='"},g=/$^/;h.template=function(a,b,d){b=b||h.templateSettings;var m=b.append?r:s,c,e=0,f;a=b.use||b.define?q(b,a,d||{}):a;a=("var out='"+
